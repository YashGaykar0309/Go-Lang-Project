...
resource "shop_vendor" "vendor_2" {
  name = "Vendor 2"
  email_address = "vendor2@example.com"
  phone_number  = "7658764877"
  address       = "Mumbai, India"
  contact       = "Person Name 2"
}

resource "shop_product" "product_1" {
  name = "Product 1"
  price = 1500
  vendor_id = shop_vendor.vendor_1.id
}
...
resource "shop_product" "product_1" {
  name = "Product 1"
  price = 1500
  vendor_id = shop_vendor.vendor_2.id
}
